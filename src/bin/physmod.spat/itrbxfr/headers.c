...
**	creates and writes headers for the output image of the turbulent
**	transfer model trbxfr
** 
*/
...

{
	...
	static GETHDR_T *request[] = {&h_lqh, &h_crh, 0};
   ...
   /* ingest LQH, CRH, other headers get passed thru */
