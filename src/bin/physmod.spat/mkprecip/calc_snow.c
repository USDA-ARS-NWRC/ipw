...
**	void
**	calc_snow(
**	    float        T_a,		|* air temperature		  *|
**	    float       *percent_snow,	|* % of precip's mass that's snow *|
...
**
**	Note: if the snow density ranges are altered, the max/min values
**	      in headers.c must also be changed.
**
*/
