/* pj12z0.f -- translated by f2c (version of 11 May 1990  14:38:39).
...
int pj12z0_0_(n__, zone, data, ipfile, iflg, geog, proj)
int n__;
int *zone;
double *data;
FILE *ipfile;
...
double *geog, *proj;
{
    ...
    double d_1;
    char angs[16 * 2];
    static double cosz, sinz, a, g, x, z, y, x0, y0;
    static double cosph0, sinph0;
    static double rh, cosphi, sinphi, coslon, con, lon, ksp, lat0, lon0;
  ...
  L_is12z0:
    *iflg = 0;
    ...
    if (ipfile != NULL) {
        fprintf(ipfile,
              "Initialization parameters (azimuthal equidistant projection):\n");
  ...
  L_pf12z0:
    *iflg = 0;
    if (switch_ != 0)
        goto L120;
    usrerr ("pj12z0_0_: Uninitialized transformation\n");
    *iflg = 1200;
    return 0;
  L120:
    d_1 = geog[1] - lon0;
    ...
    if ((d_1 = fabs(g) - 1.0, fabs(d_1)) >= epsln)
        goto L140;
    ksp = 1.0;
    if (g >= 0.0)
        goto L160;
    con = 2.0 * halfpi * a;
    usrerr ("pj12z0_0_: Point projects into a circle\n");
    *iflg = 1201;
    return 0;
  L140:
    z = acos(g);
  ...
  L220:
    ...
    if (rh <= 2.0 * halfpi * a)
        goto L230;
    usrerr ("pj12z0_0_: Improper parameter\n");
    *iflg = 1202;
    return 0;
  L230:
    z = rh / a;
...
int pj12z0_()
{
    return pj12z0_0_(0, (int*)0, (double*)0, NULL, (int*)0,
            (double*)0, (double*)0);
}

int is12z0_(zone, data, ipfile, iflg)
int *zone;
double *data;
FILE *ipfile;
int *iflg;
{
    return pj12z0_0_(1, zone, data, ipfile, iflg, (double*)0, (double*)0);
}

int pf12z0_(geog, proj, iflg)
double *geog, *proj;
int *iflg;
{
    return pj12z0_0_(2, (int*)0, (double*)0, NULL, iflg, geog, proj);
}

int pi12z0_(proj, geog, iflg)
double *proj, *geog;
int *iflg;
{
    return pj12z0_0_(3, (int*)0, (double*)0, NULL, iflg, geog, proj);
}
