/* pj11z0.f -- translated by f2c (version of 11 May 1990  14:38:39).
...
int pj11z0_0_(n__, zone, data, ipfile, iflg, geog, proj)
int n__;
int *zone;
double *data;
FILE *ipfile;
...
double *geog, *proj;
{
  ...
  L_is11z0:
    *iflg = 0;
    ...
    fprintf(ipfile, "(lambert azimuthal equal-area projection):\n");
  ...
  L_pf11z0:
    *iflg = 0;
    if (switch_ != 0)
        goto L120;
    usrerr ("pj11z0_0_: Uninitialized transformation\n");
    *iflg = 1100;
    return 0;
  L120:
    d_1 = geog[1] - lon0;
    ...
    if (g != -1.0)
        goto L140;
    con = 2.0 * a;
    usrerr ("pj11z0_0_: Point projects into a circle\n");
    *iflg = 1101;
    return 0;
  L140:
    ksp = sqrt(2.0 / (1.0 + g));
  ...
  L220:
    ...
    if (con <= 1.0)
        goto L230;
    usrerr ("pj11z0_0_: Improper parameter\n");
    *iflg = 1102;
    return 0;
  L230:
    z = 2.0 * asinz0_(&con);
...
int pj11z0_()
{
    return pj11z0_0_(0, (int*)0, (double*)0, NULL, (int*)0,
            (double*)0, (double*)0);
}

int is11z0_(zone, data, ipfile, iflg)
int *zone;
double *data;
FILE *ipfile;
int *iflg;
{
    return pj11z0_0_(1, zone, data, ipfile, iflg, (double*)0, (double*)0);
}

int pf11z0_(geog, proj, iflg)
double *geog, *proj;
int *iflg;
{
    return pj11z0_0_(2, (int*)0, (double*)0, NULL, iflg, geog, proj);
}

int pi11z0_(proj, geog, iflg)
double *proj, *geog;
int *iflg;
{
    return pj11z0_0_(3, (int*)0, (double*)0, NULL, iflg, geog, proj);
}
