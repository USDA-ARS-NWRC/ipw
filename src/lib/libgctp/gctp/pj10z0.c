/* pj10z0.f -- translated by f2c (version of 11 May 1990  14:38:39).
...
int pj10z0_0_(n__, zone, data, ipfile, iflg, geog, proj)
int n__;
int *zone;
double *data;
FILE *ipfile;
...
double *geog, *proj;
{
  ...
  L_is10z0:
    ...
    *iflg = 0;
    ...
    if (ipfile != NULL) {
        fprintf(ipfile,
                "Initialization parameters (stereographic projection):\n");
  ...
  L_pf10z0:
    *iflg = 0;
    if (switch_ != 0)
        goto L120;
    usrerr ("pj10z0_0_: Uninitialized transformation\n");
    *iflg = 1000;
    return 0;
  L120:
    d_1 = geog[1] - lon0;
    ...
    if ((d_1 = g + 1.0, fabs(d_1)) > epsln)
        goto L140;
    usrerr ("pj10z0_0_: Point projects into infinity\n");
    *iflg = 1001;
    return 0;
  L140:
    ksp = 2.0 / (1.0 + g);
...
int pj10z0_()
{
    return pj10z0_0_(0, (int*)0, (double*)0, NULL, (int*)0,
            (double*)0, (double*)0);
}

int is10z0_(zone, data, ipfile, iflg)
int *zone;
double *data;
FILE *ipfile;
int *iflg;
{
    return pj10z0_0_(1, zone, data, ipfile, iflg, (double*)0, (double*)0);
}

int pf10z0_(geog, proj, iflg)
double *geog, *proj;
int *iflg;
{
    return pj10z0_0_(2, (int*)0, (double*)0, NULL, iflg, geog, proj);
}

int pi10z0_(proj, geog, iflg)
double *proj, *geog;
int *iflg;
{
    return pj10z0_0_(3, (int*)0, (double*)0, NULL, iflg, geog, proj);
}
