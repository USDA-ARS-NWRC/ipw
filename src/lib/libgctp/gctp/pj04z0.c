...
double *geog, *proj;
{
  ...
  L120:
    ...
    if ((d_1 = lat1 + lat2, fabs(d_1)) >= epsln)
        goto L130;
    usrerr ("pj04z0_0_: Equal latitudes for st. parallels on opposite sides of equator\n");
    *iflg = 401;
    return 0;
  L130:
  ...
  L_pf04z0:
    *iflg = 0;
    if (switch_ != 0)
        goto L200;
    usrerr ("pj04z0_0_: Uninitialized transformation\n");
    *iflg = 400;
    return 0;
  L200:
    ...
    if (con > 0.0)
        goto L210;
    usrerr ("pj04z0_0_: Point cannot be projected\n");
    *iflg = 402;
    return 0;
  L210:
    rh = 0.0;
